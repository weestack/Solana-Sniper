...
#[derive(Debug, Clone)]
pub struct SolarFlareMintedTransaction {
    pub mint: Pubkey,
}
impl MintedTokenTransaction for SolarFlareMintedTransaction {
    ...
    fn get_dex(&self) -> &str { "SolarFlareAddress" }
    fn get_mint(&self) -> Pubkey { pubkey!("So1111111111111111111111111111111SolarFlare") }
