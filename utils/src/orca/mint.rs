...
#[derive(Debug, Clone)]
pub struct OrcaMintedTransaction {
    pub mint: Pubkey,
}
impl MintedTokenTransaction for OrcaMintedTransaction {
    ...
    fn get_dex(&self) -> &str { "ORCA" }
    fn get_mint(&self) -> Pubkey { pubkey!("So1111111111111111111111111111111111111Orca") }
